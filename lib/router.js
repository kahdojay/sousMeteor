...
Router.route('sms', {
  ...
  action: function () {
    ...
    var order = Orders.findOne({orderRef: this.params.query.Body})
    ...
    if(order !== undefined){
      ...
      var teamConfirmMessage = { 
        ...
        author: purveyor.orderContact && !!purveyor.orderContact.trim() ? purveyor.orderContact : purveyor.name,
        message: 'Order confirmed',
        teamId: order.teamId,
        orderId: order._id,
        purveyorId: order.purveyorId,
        purveyor: purveyor.name,
        imageUrl: (purveyor.imageUrl && !!purveyor.imageUrl.trim()) ? purveyor.imageUrl : 'https://sous-assets-production.s3.amazonaws.com/uploads/89b217dc-4ec5-43e8-9569-8fc85e6fdd52/New+Sous+Logo+Circle+Small.png',
