...
if(Meteor.isServer){
  ...
  Meteor.methods({
    ...
    resetDemoData: function(resetProducts) {
      ...
      status.import.messages = Meteor.call('importMessages', Meteor.settings.SHEETSU.DEMO_MESSAGES, Meteor.settings.APP.DEMO_TEAMCODE);
      status.import.teamTasks = Meteor.call('importTeamTasks', Meteor.settings.SHEETSU.DEMO_TASKS, Meteor.settings.APP.DEMO_TEAMCODE);
      status.import.purveyors = Meteor.call('importPurveyors', Meteor.settings.SHEETSU.PURVEYORS, Meteor.settings.APP.DEMO_TEAMCODE);
    ...
    createDemoTeam: function(userId, teamId) {
      ...
      ret.import.purveyors = Meteor.call('importPurveyors', Meteor.settings.SHEETSU.DEMO_PURVEYORS, Meteor.settings.APP.DEMO_TEAMCODE, team.teamCode);
      ...
      ret.import.teamTasks = Meteor.call('importTeamTasks', Meteor.settings.SHEETSU.DEMO_TASKS, Meteor.settings.APP.DEMO_TEAMCODE, team.teamCode);
    ...
    resetUser: function(userId) {
      ...
      Meteor.users.update({_id:userId}, {$set: {resetAppState: true}})
      ...
      Meteor.users.update({_id:userId}, {$set: {teamId: null, firstName: '', lastName: '', email: '', resetAppState: false, viewedOnboarding: false}})
    ...
    updateUser: function(userId, userAttributes) {
      ...
      if (
        ...
        teamsUpdate = Teams.update({users: {$in: [userId]}},{$set:{updatedAt: (new Date()).toISOString()}},{multi: true})
