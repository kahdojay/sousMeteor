...
if(Meteor.isServer){
  ...
  Meteor.methods({
    ...
    addCartItem: function(userId, teamId, purveyorId, cartItemAttributes) {
      log.debug("CART ITEM ATTRS", userId, teamId, purveyorId, cartItemAttributes);
      var ret = {
        insert: null,
        success: null,
      };
      ...
      if(cartItemAttributes.hasOwnProperty('_id') === true){
        cartItemInsert._id = cartItemAttributes._id;
      }

      ret.insert = CartItems.insert(cartItemInsert);
      ret.success = true;
