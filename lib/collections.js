...
if(Meteor.isServer){
  ...
  Meteor.methods({
    ...
    addCartItem: function(userId, teamId, cartItemAttributes) {
      log.debug("ADD CART ITEM ATTRS", userId, teamId, cartItemAttributes);
      var ret = {
        upsert: null,
        success: null,
      };
    ...
    sendEmail: function(requestAttributes) {
      ...
      switch(requestAttributes.type) {
        ...
        case 'UPLOAD_ORDER_GUIDE':
          ...
          emailOptions.subject = 'Order Guide Upload';
          emailOptions.text = 'Please find the attached images.';
