...
if(Meteor.isServer){
  ...
  Meteor.methods({
    ...
    resetDemoData: function() {
      ...
      // This is needed since Purveyor Id changes
      Orders.remove({teamId: status.demoTeam._id});
      CartItems.remove({teamId: status.demoTeam._id});
    ...
    importMessages: function(url, teamCode, teamCodeOverride) {
    ...
    importProducts: function(url, teamCode, teamCodeOverride) {
      if(undefined === teamCode){
        teamCode = 'all';
      }
      var ret = {
    ...
    importTeamTasks: function(url, teamCode, teamCodeOverride) {
      if(undefined === teamCode){
        teamCode = 'all';
      }
      var ret = {
