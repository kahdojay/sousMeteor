...
if(Meteor.isServer){
  ...
  Meteor.startup(function() {
    ...
    CartItems._ensureIndex(
      { teamId: 1, purveyorId: 1, productId: 1 }
    );
    // configure Mandrill
    Mandrill.config({
  ...
  Meteor.methods({
    ...
    addCartItem: function(teamId, purveyorId, productId, cartItemAttributes) {
      log.debug("CART ITEM ATTRS", teamId, purveyorId, productId, cartItemAttributes);
      var ret = {
        update: null,
        exists: null,
        success: null,
      ...
      ret.update = CartItems.update(cartItemLookup, {
        $set: {
    ...
    deleteCartItem: function(teamId, purveyorId, productId) {
      var ret = {
        delete: null,
        success: null,
      };
